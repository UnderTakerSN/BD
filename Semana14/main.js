...
<h1 style="color:blue">S/.${datos.Precio}</h1>
<hr>
</div>
            `;
      });
    ...
    function imprimirComentariosEnPantalla(){
      db.collection("comentarios").get().then((querySnapshot)=> {
       let html= '';
        ...
        var listarDatos=`<br>
        <div style="color: white;background-color: blue;border: 1px solid;border-radius: 5px;">
        <li class="listarDatos">
        <h5 class="listarDatosH5" style="color:black"> ${doc.data().titulo} </h5>
